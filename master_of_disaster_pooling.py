...
tranches_array = np.array([20, 50, 100, 200, 500, 2000])
...
csv_losses_name = "test_losses.csv"
csv_metrics_name = "test_metrics.csv"
csv_es_name = "test_es.csv"
sng_ann_losses.to_csv(OUTPUT_DIR.joinpath(csv_losses_name), index=False, sep=',')
sng_ann_ret_df_ibrd.to_csv(OUTPUT_DIR.joinpath("test_returns_ibrd.csv"), index=False, sep=',')
sng_ann_ret_df_regression.to_csv(OUTPUT_DIR.joinpath("test_returns_regression.csv"), index=False, sep=',')
sng_ann_ret_df_artemis.to_csv(OUTPUT_DIR.joinpath("test_returns_artemis.csv"), index=False, sep=',')
