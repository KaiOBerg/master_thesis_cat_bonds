...
def init_TC_exp(file_path, country, grid_size=600, buffer_size=1, load_fls=False, plot_exp=True, plot_centrs=True, plt_grd=True):
    ...
    """Define Exposure"""
    exp_str = f"exposure/Exp_{country}_{fin}_{year}_{res}.hdf5"
    ...
    haz_str = f"hazard/TC_sub_{applicable_basin}_{country}_{res}_STORM.hdf5"
