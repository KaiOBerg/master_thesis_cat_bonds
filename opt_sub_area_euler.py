'''Script to derive the optimal combination of subareas and paramteric index statistic'''
...
def sng_cty_bond(country, grid_specs, int_stat, prot_rp, file_path, storm_path, buffer_distance, buffer_grid, to_prot_share, incl_plots=False):    
    ...
    #derive basis risk for percentiles
    basis_risk_dic = {}
    for i in int_stat:
...
all_dfs = []
#first, calcualte for no division into subareas
...
#increase subareas per polygon by 1 up to 10
for i in range(10):
