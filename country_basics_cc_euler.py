...
def process_country(cty):
    ...
    ex_cc_eu.init_TC_exp(country=country, cc_model='CMCC', buffer_distance_km=105, res_exp=30, grid_size=6000, buffer_grid_size=1, load_fls=False, plot_exp=False, plot_centrs=False, plt_grd=False)
...
if __name__ == "__main__":
    ...
    process_country(country=country)
