...
def process_country(cty, cc_model):
    ...
    ex_cc_eu.init_TC_exp(country=cty, cc_model=cc_model, buffer_distance_km=105, res_exp=30, grid_size=6000, buffer_grid_size=1, load_fls=True, plot_exp=False, plot_centrs=False, plt_grd=False)
