...
def process_n(n, cntry_names, df_losses, alpha, nominals_sng, output_file):
    ...
    df_result.to_csv(output_file.joinpath(f"df_result_{n}_pools_full.csv"), index=False, sep=',')
    fig.savefig(output_file.joinpath(f"convergence_plot_{n}_pools_full.png"), dpi=300, bbox_inches='tight')
